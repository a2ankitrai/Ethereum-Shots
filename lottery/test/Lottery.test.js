...
/**
ganache is going to be our local test network that only gets created when we start running our tests by
we just require it into this file.
It automatically boots up the local test network.
*/
